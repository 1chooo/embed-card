...
For a full React integration that still uses the default card UI, prefer [`EmbedCard`](./react) or the [starter apps](../getting-started#starter-projects-full-apps) instead of re-implementing every renderer by hand.
