...
Not sure which hosts or URL shapes are supported? Read **[Supported platforms →](./platforms)** (YouTube, X, Instagram, Reddit threads, Google Maps, Vimeo, link fallback, and invalid input).
